# Source: https://arxiv.org/list/q-fin.MF/current

**Fetched:** 2026-09-09T15:09:59.108185+00:00

---

Mathematical Finance Sep 2026 
 ...
 Subjects: 
 Mathematical Finance (q-fin.MF) ; Optimization and Control (math.OC); Probability (math.PR); Risk Management (q-fin.RM)
 ...
 Subjects: 
 Methodology (stat.ME) ; Mathematical Finance (q-fin.MF); Computation (stat.CO); Other Statistics (stat.OT)
 ...
 Comments: 
 26 pages; Keywords: Viscosity solutions, Financial bubbles, Lévy processes, Free boundary
 

 Subjects: 
 Analysis of PDEs (math.AP) ; Mathematical Finance (q-fin.MF)
 ...
 Subjects: 
 Trading and Market Microstructure (q-fin.TR) ; Probability (math.PR); Mathematical Finance (q-fin.MF)
 ...
 Subjects: 
 Computational Finance (q-fin.CP) ; Optimization and Control (math.OC); Mathematical Finance (q-fin.MF)
